...
![minio_JAVA1](https://github.com/minio/minio-java-rest-example/blob/master/docs/screenshots/minio-JAVA1.png?raw=true)
...
![minio_JAVA2](https://github.com/minio/minio-java-rest-example/blob/master/docs/screenshots/minio-JAVA2.png?raw=true)


* Step 2 - Convert the project to a Maven Project as shown below
![minio_JAVA3](https://github.com/minio/minio-java-rest-example/blob/master/docs/screenshots/minio-JAVA3.png?raw=true)
...
![minio_JAVA4](https://github.com/minio/minio-java-rest-example/blob/master/docs/screenshots/minio-JAVA4.png?raw=true)
...
![minio_JAVA5](https://github.com/minio/minio-java-rest-example/blob/master/docs/screenshots/minio-JAVA5.png?raw=true)
...
![minio_JAVA6](https://github.com/minio/minio-java-rest-example/blob/master/docs/screenshots/minio-JAVA6.png?raw=true)
...
```
![minio_JAVA7](https://github.com/minio/minio-java-rest-example/blob/master/docs/screenshots/minio-JAVA7.png?raw=true)
...
![minio_JAVA8](https://github.com/minio/minio-java-rest-example/blob/master/docs/screenshots/minio-JAVA8.png?raw=true)
...
![minio_JAVA9](https://github.com/minio/minio-java-rest-example/blob/master/docs/screenshots/minio-JAVA9.png?raw=true)

* Step 2 - Add your Project to the Server
     * Click on Server-> Add / Remove Projects.
     * Select this project on the left and click on Add.
![minio_JAVA10](https://github.com/minio/minio-java-rest-example/blob/master/docs/screenshots/minio-JAVA10.png?raw=true)
...
![minio_JAVA11](https://github.com/minio/minio-java-rest-example/blob/master/docs/screenshots/minio-JAVA11.png?raw=true)
